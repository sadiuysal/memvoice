...
from src.schemas.memory import MemoryCreate, MemoryQuery, MemoryResponse, MemoryUpdate
...
async def update_memory(
    memory_id: int, memory: MemoryUpdate, db: Session = Depends(get_db)
):
...
@router.post("/cleanup/")
async def cleanup_expired_memories(db: Session = Depends(get_db)):
