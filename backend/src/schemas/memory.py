...
class MemoryBase(BaseModel):
    ...
    relevance_score: Optional[float] = Field(None, description="Relevance score for the memory entry")
    expires_at: Optional[datetime] = Field(None, description="Expiration time for short-term memory entries")
